...
class DaftarLamaran_Wawancara2 extends React.Component {
  constructor() {
    super()
  ...
  componentDidMount() {
    ...
    axios.get(`http://127.0.0.1:8000/api/tr_lamaran_kerja/viewStatusWawancara2/${id}`)
      .then(response => {
        this.setState({
  ...
  handlePageChange(pageNumber) {
    ...
    axios.get(`http://127.0.0.1:8000/api/tr_lamaran_kerja/viewStatusWawancara2/${id}?page=` + pageNumber)
      .then(response => {
        this.setState({
          tr_lamaran_kerja: response.data.data,
          itemsCountPerPage: response.data.per_page,
  ...
  cari = () => {
    const id = this.props.match.params.id;
    axios.get(`http://localhost:8000/api/tr_lamaran_kerja/searchViewStatusWawancara2/${id}?cari=` + this.state.cari)
      .then(response => {
        this.setState({
          tr_lamaran_kerja: response.data.data,
          itemsCountPerPage: response.data.per_page,
                          ...
                          ? this.state.tr_lamaran_kerja.map(tr_lamaran_kerjas => (
                            <tr key={tr_lamaran_kerjas.id}>
                              ...
                              <td>
                                ...
                                <Link to={`/${tr_lamaran_kerjas.id}/Undang_Wawancara2`} className="btn btn-warning btn-sm mr-2">Undang Wawancara</Link>
                              </td>
                            </tr>
                          ))
                          :
...
export default DaftarLamaran_Wawancara2;