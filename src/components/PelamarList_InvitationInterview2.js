...
class PelamarList_InvitationInterview2 extends React.Component {
  constructor() {
    super();
  ...
  componentDidMount() {
    ...
    // })
    axios
      .get("http://127.0.0.1:8000/api/tr_lamaran_kerja/viewInterview1")
      .then((response) => {
        this.setState({
...
export default PelamarList_InvitationInterview2;
