...
class DashboardPelamar_Decline extends Component {
  constructor(props) {
    ...
    this.handleKeteranganKonfirmasiChange = this.handleKeteranganKonfirmasiChange.bind(
      this
    );
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://127.0.0.1:8000/api/tr_lamaran_kerja/statusDecline/${id}`)
      .then((response) => {
        this.setState({
  ...
  handleFormSubmit(event) {
    ...
    axios
      .put(
        `http://127.0.0.1:8000/api/tr_lamaran_kerja/updateStatusDecline/${id}`,
        {
              ...
              <div className="box box-primary">
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    <div className="form-group">
                      <label>Confirmation Accept</label>
                      <input
                        type="text"
                        required
                        readOnly
                    ...
                    <div className="form-group">
                      <label>Applicants' Names Who's Decline</label>
                      <input
                        type="text"
                        required
                        readOnly
                    ...
                    <div className="form-group">
                      <label>Statement Rejected Job Applications</label>
                      <textarea
                        type="text"
                        required
