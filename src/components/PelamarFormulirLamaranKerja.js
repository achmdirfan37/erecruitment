...
class PelamarFormulirLamaranKerja extends Component {
    constructor(props) {
        ...
        this.handleAlasanMemilihJurusanChange = this.handleAlasanMemilihJurusanChange.bind(this);
        this.handleKaryaIlmiahChange = this.handleKaryaIlmiahChange.bind(this);
        this.handlePendidikanNonFormalChange = this.handlePendidikanNonFormalChange.bind(this);
        this.handleBahasaChange = this.handleBahasaChange.bind(this);
        this.handleStatusPernikahanChange = this.handleStatusPernikahanChange.bind(this);
        this.handleTanggalStatusPernikahanChange = this.handleTanggalStatusPernikahanChange.bind(this);
        this.handleSusunanKeluargaChange = this.handleSusunanKeluargaChange.bind(this);
        this.handleDetailAtasanBawahanChange = this.handleDetailAtasanBawahanChange.bind(this);
        this.handleMasalahDihadapiChange = this.handleMasalahDihadapiChange.bind(this);
        ...
        this.handleOrangYangMendorongChange = this.handleOrangYangMendorongChange.bind(this);
        ...
        this.handleHalMendorongBekerjaChange = this.handleHalMendorongBekerjaChange.bind(this);
        this.handleAlasanInginBekerjaChange = this.handleAlasanInginBekerjaChange.bind(this);
        this.handleGajiDiharapkanChange = this.handleGajiDiharapkanChange.bind(this);
        this.handleFasilitasDiharapkanChange = this.handleFasilitasDiharapkanChange.bind(this);
        this.handleKapanMulaiBekerjaChange = this.handleKapanMulaiBekerjaChange.bind(this);
        this.handleUrutanJenisPekerjaanChange = this.handleUrutanJenisPekerjaanChange.bind(this);
        this.handleLingkunganKerjaDiminatiChange = this.handleLingkunganKerjaDiminatiChange.bind(this);
        this.handleBersediaDiluarDaerahChange = this.handleBersediaDiluarDaerahChange.bind(this);
        this.handleTipeOrangDisenangiChange = this.handleTipeOrangDisenangiChange.bind(this);
        this.handleHalSulitMengambilKeputusanChange = this.handleHalSulitMengambilKeputusanChange.bind(this);
        this.handleKenalanDiPerusahaanAstraChange = this.handleKenalanDiPerusahaanAstraChange.bind(this);
        this.handleReferensiPerusahaanChange = this.handleReferensiPerusahaanChange.bind(this);
        this.handleHobiChange = this.handleHobiChange.bind(this);
        this.handleCaraMengisiWaktuLuangChange = this.handleCaraMengisiWaktuLuangChange.bind(this);
        this.handleOrganisasiDiikutiChange = this.handleOrganisasiDiikutiChange.bind(this);
        ...
        this.handleRiwayatPenyakitChange = this.handleRiwayatPenyakitChange.bind(this);
    ...
    handleFormSubmit(event) {
        ...
        axios.put(`http://127.0.0.1:8000/api/ms_pelamar/${id}/updateflk`, {
            ...
            pel_hal_sulit_mengambil_keputusan: this.state.pel_hal_sulit_mengambil_keputusan,
            pel_kenalan_di_perusahaan_astra: this.state.pel_kenalan_di_perusahaan_astra,
            ...
            <div className="content-wrapper">
                <section className="content" >
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Formulir Lamaran Kerja</h3>
                    </div>
                    <div className="row">
                                ...
                                <form role="form" onSubmit={this.handleFormSubmit}>
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Posisi yang Dicari</label>
                                                    <select className="form-control select2" value={this.state.pel_posisi}
                                                        onChange={(event) => this.setState({ pel_posisi: event.target.value })}>
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Kewarganegaraan</label>
                                                    <input type="text"
                                                        required
                                                        name="pel_tempat_lahir"
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">No Telepon Orang Tua</label>
                                                    <input type="text"
                                                        required
                                                        name="pel_tempat_lahir"
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Alamat Orang Tua</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_alamat"
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Status Hubungan</label>
                                                    <select className="form-control select2" value={this.state.pel_status_pernikahan}
                                                        onChange={(event) => this.setState({ pel_status_pernikahan: event.target.value })}>
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Tanggal Status Hubungan</label>
                                                    <input type="date"
                                                        required
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Susunan Anggota Keluarga : <font color="#ff0000"> *(Istri/Suami dan Anak-anak)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Susunan Anggota Keluarga" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Uraikan dengan singkat mengapa Anda memilh jurusan tersebut di Perguruan Tinggi :</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Alasan Memilih Jurusan" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan karya ilmiah yang pernah Anda buat : <font color="#ff0000"> *(skripsi, artikel, karya tulis, dll)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Karya Ilmiah" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan Pendidikan Non-Formal yang Diikuti :</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Pendidikan Non Formal yang Diikuti" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan Bahasa Asing yang Dikuasai :</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_bahasa"
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan siapa yang pernah menjadi atasan :<font color="#ff0000"> *(Nama Atasan, Jabatan, Nama Perusahaan dan Jumlah Bawahan)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Atasan Anda" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Masalah penting apa saja yang pernah Anda hadapi, dan bagaimana mengatasinya?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Masalah yang pernah dihadapi dan cara mengatasinya" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Ceritakan pandangan/kesan Anda terhadap perusahaan yang pernah anda tempati</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Pandangan/Kesan Anda Terhadap Perusahaan yang pernah anda tempati" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Pernahkah anda melakukan pembaharuan/perubahan di perusahaan yang pernah anda tempati?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan pembaharuan/perubahan yang pernah dilakukan di perusahaan yang pernah anda tempati" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Siapakah yang mendorong anda hingga sampai taraf kemajuan seperti sekarang ini?</label>
                                                    <input type="text"
                                                        required
                                                        ...
                                                        className="form-control"
                                                        placeholder="Masukkan orang yang mendorong anda hingga taraf kemajuan saat ini" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Bagaimana bila anda menghadapi persoalan dalam pekerjaan dan harus mengambil keputusan?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan cara menghadapi persoalan dalam pekerjaan dan mengambil keputusan" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Uraikan apa yang menjadi cita-cita anda</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_cita_cita"
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Apa yang mendorong Anda ingin bekerja :</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan hal yang mendorong anda untuk bekerja" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Mengapa Anda ingin bekerja di Perusahaan kami?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan alasan ingin bekerja di Perusahaan ini" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan gaji yang Anda inginkan :</label>
                                                    <input type="text"
                                                        required
                                                        ...
                                                        className="form-control"
                                                        placeholder="Masukkan gaji yang Anda inginkan" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan fasilitas lainnya yang Anda harapkan :</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan fasilitas yang diharapkan" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Kapan Anda dapat mulai bekerja :</label>
                                                    <input type="text"
                                                        required
                                                        ...
                                                        className="form-control"
                                                        placeholder="Masukkan waktu anda dapat mulai bekerja" />
                                                </div>
                                                <div class="box">
                                                    <div class="box-body">
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Pilih jenis pekerjaan berikut sesuai dengan prioritas pekerjaan yang Anda minati :<font color="#ff0000"> *(Minimal 3 Jenis)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={3}
                                                        cols={3}
                                                        placeholder="Masukkan 3 jenis pekerjaan" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Lingkungan kerja yang disenangi :</label>
                                                    <select className="form-control select2" value={this.state.pel_lingkungan_kerja_diminati}
                                                        onChange={(event) => this.setState({ pel_lingkungan_kerja_diminati: event.target.value })}>
                                                        <option value="Lapangan">Lapangan</option>
                                                        <option value="Kantor">Kantor</option>
                                                    </select>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Bersediakah Anda ditempatkan diluar daerah?</label>
                                                    <select className="form-control select2" value={this.state.pel_bersedia_diluar_daerah}
                                                        onChange={(event) => this.setState({ pel_bersedia_diluar_daerah: event.target.value })}>
                                                        <option value="Ya">Ya</option>
                                                        <option value="Tidak">Tidak</option>
                                                    </select>
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan tipe orang yang Anda senangi :</label>
                                                    <input type="text"
                                                        required
                                                        ...
                                                        className="form-control"
                                                        placeholder="Masukkan tipe orang yang disenangi" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Terhadap hal apa Anda sulit mengambil keputusan?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={3}
                                                        cols={3}
                                                        placeholder="Masukkan hal tersulit dalam mengambil keputusan" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Adakah kenalan Anda di perusahaan Astra Group? <font color="#ff0000"> *(Nama Kenalan, Nama Perusahaan, Jabatan, No Telepon dan Hubungan)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan kenalan dalam perusahaan Astra Group" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Sebutkan referensi Anda di luar perusahaan kami :<font color="#ff0000"> *(Nama Perusahaan, Jabatan dan No Telepon)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan referensi perusahaan lain" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Hobby/Kegemaran Anda :</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_hobi"
                                                        ...
                                                        rows={2}
                                                        cols={2}
                                                        placeholder="Masukkan hobby/Kegemaran Anda" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Bagaimana cara Anda mengisi waktu luang?</label>
                                                    <textarea type="text"
                                                        required
                                                        ...
                                                        rows={3}
                                                        cols={3}
                                                        placeholder="Masukkan cara anda mengisi waktu luang" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Organisasi yang pernah Anda ikuti :<font color="#ff0000"> *(Nama Organisasi, Tempat, Jabatan, Tahun Menjabat)</font></label>
                                                    <textarea type="text"
                                                        required
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="box-body">
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Pernahkah Anda mengikuti psikotest sebelumnya?<font color="#ff0000"> *(Waktu, Tempat dan Tujuan)</font></label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_psikotes"
                                                        ...
                                                        rows={5}
                                                        cols={5}
                                                        placeholder="Masukkan Psikotes yang pernah anda ikuti" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Apa yang menjadi kekuatan (strong point) Anda?</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_kekuatan"
                                                        ...
                                                        rows={3}
                                                        cols={3}
                                                        placeholder="Masukkan Kekuatan Anda" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">3.	Apa yang Anda rasakan perlu diperbaiki (weak point) pada diri Anda?</label>
                                                    <textarea type="text"
                                                        required
                                                        name="pel_kelemahan"
                                                        ...
                                                        rows={3}
                                                        cols={3}
                                                        placeholder="Masukkan Kelemahan Anda" />
                                                </div>
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Pernahkah Anda menderita sakit yang lama sembuh?<font color="#ff0000"> *(Nama Penyakit, Lama Sakit dan Akibatnya)</font></label>
                                                    <textarea type="text"
                                                        required
                                                ...
                                                <div className="form-group">
                                                    <label htmlFor="exampleInputEmail1">Diisi dengan sesungguhnya, Apabila dikemudian hari ternyata ada hal-hal yang bertentangan, maka saya bersedia dituntut sesuai dengan hukuman yang berlaku dan lamaran ini dapat dibatalkan.</label>
                                                    <input type="text"
                                                        required
                                                        readOnly
