                                ...
                                <form role="form" onSubmit={this.handleFormSubmit}>
                                    <div className="box-body">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Profile Picture <font color="#ff0000"> format file *png, jpg, jpeg</font></label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Parent's Phone Number</label>
                                            <input type="text"
                                                required
                                                name="pel_tempat_lahir"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Parent's Address</label>
                                            <textarea type="text"
                                                required
                                                name="pel_alamat"
