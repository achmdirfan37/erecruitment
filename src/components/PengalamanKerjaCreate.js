...
export default class PengalamanKerjaCreate extends Component {
  constructor(props) {
    ...
    this.handleNamaPerusahaanInputChange = this.handleNamaPerusahaanInputChange.bind(
      this
    );
    this.handleTanggalMulaiInputChange = this.handleTanggalMulaiInputChange.bind(
      this
    );
    this.handleTanggalSelesaiInputChange = this.handleTanggalSelesaiInputChange.bind(
      this
    );
    ...
    this.handleGambarPekerjaanInputChange = this.handleGambarPekerjaanInputChange.bind(
      this
    );
    this.handleSpesialisasiInputChange = this.handleSpesialisasiInputChange.bind(
      this
    );
    this.handleBidangPekerjaanInputChange = this.handleBidangPekerjaanInputChange.bind(
      this
    );
