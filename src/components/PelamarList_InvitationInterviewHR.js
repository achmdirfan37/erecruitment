...
class PelamarList_InvitationInterviewHR extends React.Component {
  constructor() {
    super();
  ...
  componentDidMount() {
    ...
    // })
    axios
      .get("http://127.0.0.1:8000/api/tr_lamaran_kerja/viewInterview2")
      .then((response) => {
        this.setState({
  ...
  handlePageChange(pageNumber) {
    ...
    axios
      .get(
        "http://127.0.0.1:8000/api/tr_lamaran_kerja/viewBelumDibaca?page=" +
          pageNumber
      )
      .then((response) => {
        this.setState({
  ...
  cari = () => {
    axios
      .get(
        "http://localhost:8000/api/tr_lamaran_kerja/search?cari=" +
          this.state.cari
      )
      .then((response) => {
        this.setState({
...
export default PelamarList_InvitationInterviewHR;
