...
class PelamarEdit extends Component {
  constructor(props) {
    ...
    this.handleTanggalLahirUpdateChange = this.handleTanggalLahirUpdateChange.bind(
      this
    );
    this.handleJenisKelaminUpdateChange = this.handleJenisKelaminUpdateChange.bind(
      this
    );
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios
      .put(`http://127.0.0.1:8000/api/ms_pelamar/${id}/update`, {
                ...
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    <div className="form-group">
                      ...
                      <br />
                      <div
                        onChange={this.handleJenisKelaminUpdateChange.bind(
                          this
                        )}
                      >
                        <input
