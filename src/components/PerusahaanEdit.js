...
class PelamarEdit extends Component {
  constructor(props) {
    ...
    this.handleAlamatWebsiteUpdateChange = this.handleAlamatWebsiteUpdateChange.bind(
      this
    );
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://127.0.0.1:8000/api/ms_perusahaan/edit/${id}`)
      .then((response) => {
        this.setState({
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios
      .put(`http://127.0.0.1:8000/api/ms_perusahaan/update/${id}`, {
