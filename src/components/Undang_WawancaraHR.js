...
class Undang_WawancaraHR extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      lk_nama: "",
  ...
  handleFormSubmit(event) {
    alert("Undangan Wawancara 1 Berhasil!");
    event.preventDefault();
    const id = this.props.match.params.id;
    axios
      .put(
        `http://127.0.0.1:8000/api/tr_lamaran_kerja/undangTerimaInterview/${id}`,
        {
      ...
      .then((response) => {
        ...
        this.props.history.push("/PelamarList_InvitationInterview");
      })
      .catch((err) => console.log(err));
  }
    ...
    return (
      <div className="content-wrapper">
        ...
        <section className="content-header">
          <h1>Undang Wawancara 1</h1>
          <ol className="breadcrumb">
            <li className="active">Undang Wawancara 1</li>
          </ol>
        </section>
...
export default Undang_WawancaraHR;
