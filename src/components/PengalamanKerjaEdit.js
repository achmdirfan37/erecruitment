...
class PengalamanKerjaEdit extends Component {
  constructor(props) {
    ...
    this.handleNamaPerusahaanUpdateChange = this.handleNamaPerusahaanUpdateChange.bind(
      this
    );
    this.handleTanggalMulaiUpdateChange = this.handleTanggalMulaiUpdateChange.bind(
      this
    );
    this.handleTanggalSelesaiUpdateChange = this.handleTanggalSelesaiUpdateChange.bind(
      this
    );
    this.handleLokasiUpdateChange = this.handleLokasiUpdateChange.bind(this);
    this.handleIndustriUpdateChange = this.handleIndustriUpdateChange.bind(
      this
    );
    this.handleGambarPekerjaanUpdateChange = this.handleGambarPekerjaanUpdateChange.bind(
      this
    );
    this.handleSpesialisasiUpdateChange = this.handleSpesialisasiUpdateChange.bind(
      this
    );
    this.handleBidangPekerjaanUpdateChange = this.handleBidangPekerjaanUpdateChange.bind(
      this
    );
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://127.0.0.1:8000/api/ms_pengalaman_kerja/${id}/edit`)
      .then((response) => {
        this.setState({
  ...
  handleFormSubmit(event) {
    ...
    axios
      .post("http://127.0.0.1:8000/api/ms_pengalaman_kerja/create", {
              ...
              <div className="box box-primary">
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    <div className="form-group">
                      <label>Start Year of Work</label>
                      <input
                        type="date"
                        required
                    ...
                    <div className="form-group">
                      <label>Finish Year of Work</label>
                      <input
                        type="date"
                        required
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        value={this.state.pkj_jabatan}
                        onChange={(event) =>
                          this.setState({ pkj_jabatan: event.target.value })
                        }
                      >
