                ...
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    {/* <div className="form-group">
                      ...
                      <br />
                      <p htmlFor="exampleInputEmail1">Definisi : Sopan/Rapi</p>
                    ...
                    <div className="form-group">
                      <label htmlFor="exampleInputEmail1">PENAMPILAN/SIKAP</label>
                      <br />
                      <p htmlFor="exampleInputEmail1">Definisi : Sopan/Rapi</p>
                      <div onChange={this.handlePenampilanSikapChange.bind(this)}>
                        <input type="radio" name="pn_penampilan_sikap" value="1" />Need Improvement 1
                        <br />
                        <input type="radio" name="pn_penampilan_sikap" value="2" />Need Improvement 2
                        <br />
                        <input type="radio" name="pn_penampilan_sikap" value="3" />Meet Requirement 3
                        <br />
                        <input type="radio" name="pn_penampilan_sikap" value="4" />Highly Effective 4
                        <br />
                        <input type="radio" name="pn_penampilan_sikap" value="5" />Highly Effective 5
                      </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <select className="form-control select2" value={this.state.pn_kesimpulan}
                        ...
                        <option value="Direkomendasikan Untuk Mengikuti Test Berikutnya">Direkomendasikan Untuk Mengikuti Test Berikutnya</option>
