...
class RoleEdit extends Component {
  constructor(props) {
    ...
    this.handleUsernameUpdateChange = this.handleUsernameUpdateChange.bind(
      this
    );
  ...
  componentDidMount() {
    ...
    axios
      .get(`http://127.0.0.1:8000/api/ms_role/edit/${id}`)
      .then((response) => {
        this.setState({
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios
      .put(`http://127.0.0.1:8000/api/ms_role/update/${id}`, {
                  ...
                  <div className="box-body">
                    <div className="form-group">
                      ...
                      <select
                        ...
                        value={this.state.rol_perusahaan}
                        onChange={(event) =>
                          this.setState({ rol_perusahaan: event.target.value })
                        }
                      >
