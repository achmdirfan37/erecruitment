...
class DashboardPenilaian_Pelamar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      lk_nama: "",
  ...
  componentDidMount() {
    ...
    const low = 1;
    axios
      .get(`http://127.0.0.1:8000/api/ms_lowongan/viewDetail/${low}`)
      .then((response) => {
        this.setState({
  ...
  handleFormSubmit(event) {
    alert("Undangan Medical Check Up Berhasil!");
    event.preventDefault();
    const id = this.props.match.params.id;
    axios
      .put(`http://127.0.0.1:8000/api/tr_lamaran_kerja/undangTerimaMCU/${id}`, {
      ...
      .then((response) => {
        ...
        this.props.history.push("/PelamarList_InvitationMCU");
      })
      .catch((err) => console.log(err));
  }
    ...
    return (
      <div className="content-wrapper">
        ...
        <section className="content-header">
          <h1>Undang Medical Check Up</h1>
          <ol className="breadcrumb">
            <li className="active">Undang Medical Check Up</li>
          </ol>
        </section>
                ...
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        value={this.state.lk_hari}
                        onChange={(event) =>
                          this.setState({ lk_hari: event.target.value })
                        }
                      >
                    ...
                    <div className="form-group">
                      ...
                      <select
                        className="form-control select2"
                        value={this.state.lk_waktu}
                        onChange={(event) =>
                          this.setState({ lk_waktu: event.target.value })
                        }
                      >
                  ...
                  <div className="box-footer">
                    <button type="submit" className="btn btn-primary">
                      Undang Medical Check Up Pelamar
                    </button>
                  </div>
                </form>
              </div>
...
export default DashboardPenilaian_Pelamar;
