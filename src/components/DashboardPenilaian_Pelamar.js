...
class DashboardPenilaian_Pelamar extends React.Component {
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios.put(`http://127.0.0.1:8000/api/tr_lamaran_kerja/undangTerimaMCU/${id}`, {
              ...
              <div className="box box-primary">
                <form role="form" onSubmit={this.handleFormSubmit}>
                  ...
                  <div className="box-footer">
                    <button type="submit" className="btn btn-primary">Undang Medical Check Up Pelamar</button>
                  </div>
                </form>
              </div>
            </div>
