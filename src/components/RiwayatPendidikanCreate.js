...
export default class RiwayatPendidikanCreate extends Component {
  constructor(props) {
    ...
    this.handleNamaLembagaPendidikanInputChange = this.handleNamaLembagaPendidikanInputChange.bind(
      this
    );
    this.handleTahunLulusInputChange = this.handleTahunLulusInputChange.bind(
      this
    );
    ...
    this.handleKeteranganPrestasiInputChange = this.handleKeteranganPrestasiInputChange.bind(
      this
    );
  ...
  handleFormSubmit(event) {
    ...
    axios
      .post("http://127.0.0.1:8000/api/ms_riwayat_pendidikan/create", {
