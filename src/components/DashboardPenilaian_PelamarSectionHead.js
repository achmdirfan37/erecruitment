...
class DashboardPenilaian_PelamarHead extends React.Component {
  constructor(props) {
    ...
    this.handleInterpersonalSkillChange = this.handleInterpersonalSkillChange.bind(
      this
    );
    this.handleAnalysisJudgmentChange = this.handleAnalysisJudgmentChange.bind(
      this
    );
    this.handlePlanningDrivingActionChange = this.handlePlanningDrivingActionChange.bind(
      this
    );
    this.handleLeadingMotivatingChange = this.handleLeadingMotivatingChange.bind(
      this
    );
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios
      .post("http://127.0.0.1:8000/api/tr_penilaian_lamaran/createHead", {
    ...
    return (
      <div className="content-wrapper">
        ...
        <section className="content-header">
          <h1>Formulir Penilaian Section Head Gol 4</h1>
              ...
              <div className="box box-primary">
                <form role="form" onSubmit={this.handleFormSubmit}>
                  <div className="box-body">
                    ...
                    <div className="form-group">
                      <label>
                        <b>INTERPERSONAL SKILL</b>
                      </label>
                      <br />
                      <p>
                        {" "}
                        Keterampilan komunikasi yang baik, sehingga dapat
                        mempengaruhi orang lain, mampu membangun hubungan baik
                        dengan berbagai orang dari berbagai tingkatan.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_interpersonal_skill}
                        onChange={(event) =>
                          this.setState({
                            pn_interpersonal_skill: event.target.value,
                          })
                    ...
                    <div className="form-group">
                      <label>
                        <b>ANALYSIS AND JUDGMENT</b>
                      </label>
                      <br />
                      <p>
                        {" "}
                        Kemampuan mengumpulkan dan menganalisa data dan
                        informasi penting guna memahami penyebab dari suatu
                        masalah, serta mendukungnya dalam membuat keputusan
                        dengan cepat dan tepat.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_analysis_judgment}
                        onChange={(event) =>
                          this.setState({
                            pn_analysis_judgment: event.target.value,
                          })
                    ...
                    <div className="form-group">
                      <label>
                        <b>PLANNING AND DRIVING ACTION</b>
                      </label>
                      <br />
                      <p>
                        Kemampuan menetapkan obyektif dan rencana yang jelas dan
                        sistematis, serta memanfaatkan sumber daya guna mencapai
                        hasil yang diinginkan.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_planning_driving_action}
                        onChange={(event) =>
                          this.setState({
                            pn_planning_driving_action: event.target.value,
                          })
                    ...
                    <div className="form-group">
                      <label>
                        <b>LEADING AND MOTIVATING</b>
                      </label>
                      <br />
                      <p>
                        Kemampuan peran sebagai pemimpin dengan nyaman,
                        menghargai kebutuhan dan perasaan orang lain (termasuk
                        bawahan) dan menggunakan gaya memimpin dan memotivasi
                        yang sesuai dengan kebutuhan bawahan.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_leading_motivating}
                        onChange={(event) =>
                          this.setState({
                            pn_leading_motivating: event.target.value,
                          })
                    ...
                    <div className="form-group">
                      ...
                      <br />
                      <p>
                        Kemampuani untuk bekerja secara bersama-sama dengan
                        sekelompok orang untuk mencapai tujuan tertentu.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_team_work}
                        onChange={(event) =>
                          this.setState({ pn_team_work: event.target.value })
                        }
                      >
                        <option value="1">Need Improvement 1</option>
                        <option value="2">Need Improvement 2</option>
                    ...
                    <div className="form-group">
                      <label>
                        <b>DRIVE AND COURAGE</b>
                      </label>
                      <br />
                      <p>
                        Kemauan untuk belajar dan fokus pada unjuk kerja, tidak
                        takut berhadapan langsung dengan hal-hal yang belum
                        jelas, bertentangan dan memiliki resiko langsung.
                      </p>
                      <select
                        className="form-control select2"
                        value={this.state.pn_drive_courage}
                        onChange={(event) =>
                          this.setState({
                            pn_drive_courage: event.target.value,
                          })
