...
class PelamarChangePassword extends Component {
  constructor(props) {
    ...
    this.handlePasswordUpdateChange = this.handlePasswordUpdateChange.bind(
      this
    );
    this.handleOldPasswordUpdateChange = this.handleOldPasswordUpdateChange.bind(
      this
    );
    this.handleNewPasswordUpdateChange = this.handleNewPasswordUpdateChange.bind(
      this
    );
    this.handleConfirmationPasswordUpdateChange = this.handleConfirmationPasswordUpdateChange.bind(
      this
    );
  }
  ...
  handleFormSubmit(event) {
    ...
    const id = this.props.match.params.id;
    axios
      .put(`http://127.0.0.1:8000/api/ms_pelamar/${id}/changePassword`, {
