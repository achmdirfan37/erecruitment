...
export default class RiwayatPendidikanEdit extends Component {
    ...
    handleFormSubmit(event){
        ...
        const id = this.props.match.params.id;
        axios.put(`http://127.0.0.1:8000/api/ms_riwayat_pendidikan/${id}/update`,{
                                ...
                                <form role="form" onSubmit={this.handleFormSubmit}>
                                    <div className="box-body">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Lembaga Pendidikan</label>
                                            <input type="text"
                                                required
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Tahun Lulus</label>
                                            <input type="text"
                                                required
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Jenjang Pendidikan</label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Jurusan</label>
                                            <input type="text"
                                                required
                                                name="rpd_jurusan"
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Prestasi</label>
                                            <textarea type="text"
                                                required
